...
%qr = EulerAngles2Quaternions([45;45;45]*pi/180);
qr = [sqrt((2/3) * (3 + sqrt(3)))/2; sqrt((1/3) * (3 - sqrt(3)))/2; -sqrt((1/3) * (3 - sqrt(3)))/2; 0];
qi = [sqrt((2/3) * (3 + sqrt(3)))/2; sqrt((1/3) * (3 - sqrt(3)))/2; -sqrt((1/3) * (3 - sqrt(3)))/2; 0];
